...
export const TASKS: Task[] = [
    ...
    { id: 2, category: 'CHORE', name: '健康診断の申し込み', doToday: false, deadline: new Date(),
      link: 'http://www.nerima-med.or.jp/iryokenshin/', description: 'スプレッドシートに社員番号と名前を記入する', ticketId: null, archive: false},
    ...
    { id: 4, category: 'TICKET', name: '[JIRA-1459]DAO -> APIアクセス', doToday: true, deadline: new Date(),
      link: 'https://ja.wikipedia.org/wiki/Data_Access_Object', description: 'データベースアクセスしている箇所を洗い出して報告', ticketId: null, archive: false},
    { id: 5, category: 'TICKET', name: '[JIRA-1459]Grafanaのダッシュボード作成', doToday: true, deadline: new Date(),
      link: 'https://grafana.com/', description: 'バックエンドアプリケーションのGrafanaダッシュボードを作成する', ticketId: null, archive: false}
  ];
